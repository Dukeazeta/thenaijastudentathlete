            ...
            <div className="col-span-1 lg:col-span-12">
                {news.map((item, i) => (
                    ...
                    >
                        ...
                        {/* Date Col */}
                        <div className="col-span-1 lg:col-span-2 p-6 lg:p-12 border-b-hard lg:border-b-0 lg:border-r-hard flex items-start">
                            <span className="font-display text-3xl text-primary">{item.date}</span>
                        </div>
                        ...
                        {/* Action Col */}
                        <div className="col-span-1 lg:col-span-3 p-6 lg:p-12 border-t-hard lg:border-t-0 lg:border-l-hard flex flex-col justify-between items-end bg-white/50">
                            ...
                            <span className="font-display text-2xl group-hover:translate-x-2 transition-transform">Read Article →</span>
                        </div>
